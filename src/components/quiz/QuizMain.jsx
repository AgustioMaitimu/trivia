...
function QuizMain() {
  ...
  return (
    <div
      className={`${lato.className} flex h-screen w-screen items-center justify-center bg-[#F7F5F3]`}
    >
      <div className="flex h-full w-full max-w-[1280px] flex-col">
        <div className="flex h-fit w-full items-center justify-between bg-transparent p-8">
          <div
